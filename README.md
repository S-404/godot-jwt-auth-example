...
# Пример JWT аутентификации для Godot 4

Этот проект демонстрирует клиентскую систему аутентификации с автоматическим обновлением токенов, управлением cookies и чистой сервис-ориентированной архитектурой.
...
Проект ожидает следующие ендпойнты бэкенда:

- POST /auth/register - Регистрация пользователя
- POST /auth/login - Вход пользователя
- POST /auth/refresh - Обновление токена
- POST /auth/logout - Выход пользователя
- POST /action/doSmth - Пример защищенного ендпойнта
